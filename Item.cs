...
namespace Fiatsoft.Alert.Grid {
    public class Item {
        ...
        //public static bool ItemExpandEnvironmentVariables { get; private set; } = (Properties.Settings.Default.Properties[nameof(ItemExpandEnvironmentVariables)]?.DefaultValue as bool?) ?? true;
